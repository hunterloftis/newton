...
function RopeConstraint(p1, p2, distance) {
  if (!(this instanceof RopeConstraint)) return new RopeConstraint(p1, p2, distance);
  Constraint.call(this);

  this._p1 = p1;
  this._p2 = p2;
  this._distance = (typeof distance === 'undefined') ? this.getDistance() : distance;
  this._stiffness = 1;
}
...
function Simulator(options) {
  ...
  this._iterations = 5;             // TODO: option
}
